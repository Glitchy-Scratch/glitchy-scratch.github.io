  ...
  var y = /:[0-9]+$/,
    A = function (a, b) {
      ...
      "port" === b
        ...
        : "host" === b && (a.hostname = (a.hostname || r.location.hostname).replace(y, "").toLowerCase());
      var c = z(a.protocol);
      b && (b = String(b).toLowerCase());
      switch (b) {
      ...
      if ("cookie" == P(a, ac)) {
        ...
        if (a.get(je)) {
          ...
          if (c) {
            ...
            g && "aw.ds" != g
              ? b && (b.ua = !0)
              : ((c = ["1", e, Cc(c)].join(".")), 0 < d && (b && (b.ta = !0), zc("_gac_" + Cc(k), c, ca, l, k, d, w)));
            le(b);
          }
        } else J(75);
  ...
  var Sd = function (a) {
    if (!a.get("dcLoaded") && "cookie" == a.get(ac)) {
      ...
      if (se(a)) {
        ...
        a.set(Md, 1, !0);
        c
          ? (J(79), a.set(ad, "d", !0), a.set(qe, { U: re(b, a, 1), google: re(b, a, 2), count: 0 }, !0))
          : a.set(ad, "b", !0);
      }
    }
  };
      ...
      if (
        ...
        if ((c && e && J(36), a.get(bc) || ye(a.get(Kd)))) {
          ...
          g
            ...
            : ca && (e = ca.split(".")) && 2 === e.length && (J(37), a.data.set(ce, e[0]), a.data.set(fe, e[1]));
